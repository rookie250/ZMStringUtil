...
Pod::Spec.new do |s|
  s.name             = 'ZMStringUtil'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZMStringUtil.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/周明/ZMStringUtil'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '周明' => 'mmix1009@163.com' }
  s.source           = { :git => 'https://github.com/周明/ZMStringUtil.git', :tag => s.version.to_s }
